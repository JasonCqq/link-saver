  ...
  versions = [
    {
      ...
      updates: [
        "Web view - can display external sites on our site through web view, unsupported sites will still display but will not look as good",
        "Embed view - can play videos on our site, on sites like youtube, vimeo etc. (Please note not all sites are supported, if you want a site to be added, please contact me)",
        "Brought back screenshots when image not available",
        "Revamped UI (including forms)",
      ...
      qols: [
        ...
        "Thumbnails can now be magnified",
        "Thumbnails now update automatically",
        "Added info text on webview/embed",
        "Added breadcrumb messages for tasks",
      ...
      bugfixes: ["Added a rate limit to web view endpoint"],
    },
    {
      id: 10,
